...
if __name__ == "__main__":
    ...
    axs[0, 0].set_title("Input: cue + go signal")
    axs[1, 0].set_title("Desired output")
    axs[0,0].set_xlabel("Time steps")
    axs[0, 0].set_ylabel("Input strength")
    axs[1,0].set_xlabel("Time steps")
    axs[1, 0].set_ylabel("Neural response")
    # axs[0,1].legend()
    ...
    axs[0, 1].set_title("Input: only go")
    axs[1, 1].set_title("Desired output")
    axs[0,1].set_xlabel("Time steps")
    axs[0, 1].set_ylabel("Input strength")
    axs[1,1].set_xlabel("Time steps")
    axs[1, 1].set_ylabel("Neural response")
    # axs[0].set_title("Training sample: " + str(which_plot))
    # axs[1,0].legend()
    # axs[1,1].legend()

    # axs[0, 1].plot(x[:, which_val_plot, 0], label="0", alpha=0.5)
    # axs[1, 1].plot(y[:, which_val_plot, 0], label="0", alpha=0.5)
    # axs[0, 1].set_title("Validation"+str(which_val_plot))
    # axs[0].legend()
    # axs[1].legend()
