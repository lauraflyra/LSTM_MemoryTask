...
from src.models.network_one_neuron_Geadah_AF import NetworkOneNeuronGeadah
...
model = NetworkOneNeuronGeadah()
dict_results_one_neuron = train(dataset,
                                model,
                                n_epochs=3000,
                                data_path=PATH_RESULTS_ONE_NEURON,
                                save_params_name=os.path.join(PATH_RESULTS_ONE_NEURON, "params_one_neuron_Geadah.mat"),
                                save_model_name=os.path.join(PATH_RESULTS_ONE_NEURON, "model_one_neuron_Geadah.pt"),
                                checkpoints_file_name="model_checkpoints_one_neuron_Geadah")
